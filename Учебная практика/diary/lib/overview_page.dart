...
import 'package:diary/adminPanel/admin_panel.dart';
import 'package:diary/adminPanel/login_page.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ValueListenableBuilder(
                    valueListenable: DatabaseWorker.currentUserNotifier,
                      ...
                      return value == null
                          ? OutlinedButton(
                              ...
                              child: const Icon(Icons.person_rounded,
                                  color: Color(0xFFffe020)),
                              style: style)
                          : OutlinedButton(
                              onPressed: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        (value as User).role < 2
                                            ? const AdminPanel()
